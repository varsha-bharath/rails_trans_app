class DriversController < ApplicationController
	...
	def driver_params
		params[:driver].permit(:id,:name, :age,:blood_group, :mobile_no, :address, :emergency_contact, :dl_expiration, :back_ground_check, :image_p, :image_dl, :driver_salary, :pan, :bank_account, :ifsc_code)
	end
end
